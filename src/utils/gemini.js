...
export async function analyzeResults(testResults, profile, apiKey, language = 'en') {
  ...
  const langNames = { en: 'English', fr: 'French', ar: 'Arabic', sw: 'Swahili' };
...
export function getLocalSummary(scores, language = 'en') {
  ...
  const messages = {
    ...
    sw: {
      emergency: '⚠️ Baadhi ya majibu yako yanaonyesha unaweza kuhitaji huduma ya macho ya haraka. Tafadhali mwone daktari au nenda kliniki haraka iwezekanavyo.',
      urgent: 'Baadhi ya matokeo ya vipimo vyako yanahitaji uangalizi. Tunapendekeza umwone mtaalamu wa macho hivi karibuni.',
      soon: 'Uchunguzi wako unaonyesha maeneo kadhaa ambayo yanaweza kufaidika na ukaguzi wa macho. Fikiria kumwona daktari wa macho.',
      routine: 'Matokeo yako ya uchunguzi wa macho yanaonekana mazuri. Endelea kulinda macho yako na kupata ukaguzi wa mara kwa mara.',
    },
  };
